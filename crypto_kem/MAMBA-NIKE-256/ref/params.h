...
#define NIKE_LEVEL 256
#define PARAM_N 1024
#define PARAM_K 2   /* eta_s=eta_r=2: centered binomial(4)-2, range [-2,2] */
#define PARAM_Q 8192 /* 2^13 */
#define LOG2Q 13
#define PARAM_T_PK 10
#define PARAM_T_U 10
#define PARAM_T_V 6
...
#define NIKE_SECURITY_BITS NIKE_LEVEL

#if NIKE_SECURITY_BITS <= 256
#define NIKE_SSBYTES 32
#else
#define NIKE_SSBYTES ((NIKE_SECURITY_BITS + 7) / 8)
#endif
