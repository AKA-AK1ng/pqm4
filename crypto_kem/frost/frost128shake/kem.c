...
int crypto_kem_enc(uint8_t *ct, uint8_t *ss, const uint8_t *pk)
{
    ...
    quantize_dithered_local(Bp_split, Bp_raw, PARAMS_N * PARAMS_NBAR, salt, BYTES_SALT, DITHER_DOMAIN_U, PARAMS_U_LOGP);
    ...
    quantize_dithered_local(C_split, C_enc, PARAMS_NBAR * PARAMS_NBAR, salt, BYTES_SALT, DITHER_DOMAIN_V, PARAMS_V_LOGP);
