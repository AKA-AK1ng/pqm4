...
.macro c3_4x4_32 out, a0, a1, a2, a3, b0, b1, b2, b3, twiddle, Qprime, Q, tmp, tmp2
    smull.w \tmp, \out, \a0, \b3
    smlal.w \tmp, \out, \a1, \b2
    smlal.w \tmp, \out, \a2, \b1
    smlal.w \tmp, \out, \a3, \b0
    mul.w \tmp2, \tmp, \Qprime
    smlal.w \tmp, \out, \tmp2, \Q
.endm

.macro c2_4x4_32 out, a0, a1, a2, a3, b0, b1, b2, b3, twiddle, Qprime, Q, tmp, tmp2
    smull.w \tmp, \out, \a3, \b3
    mul.w \tmp2, \tmp, \Qprime
    smlal.w \tmp, \out, \tmp2, \Q
    smull.w \tmp, \out, \out, \twiddle
    smlal.w \tmp, \out, \a0, \b2
    smlal.w \tmp, \out, \a1, \b1
    smlal.w \tmp, \out, \a2, \b0
    mul.w \tmp2, \tmp, \Qprime
    smlal.w \tmp, \out, \tmp2, \Q
.endm

.macro c1_4x4_32 out, a0, a1, a2, a3, b0, b1, b2, b3, twiddle, Qprime, Q, tmp, tmp2
    smull.w \tmp, \out, \a2, \b3
    smlal.w \tmp, \out, \a3, \b2
    mul.w \tmp2, \tmp, \Qprime
    smlal.w \tmp, \out, \tmp2, \Q
    smull.w \tmp, \out, \out, \twiddle
    smlal.w \tmp, \out, \a0, \b1
    smlal.w \tmp, \out, \a1, \b0
    mul.w \tmp2, \tmp, \Qprime
    smlal.w \tmp, \out, \tmp2, \Q
.endm

.macro c0_4x4_32 out, a0, a1, a2, a3, b0, b1, b2, b3, twiddle, Qprime, Q, tmp, tmp2
    smull.w \tmp, \out, \a1, \b3
    smlal.w \tmp, \out, \a2, \b2
    smlal.w \tmp, \out, \a3, \b1
    mul.w \tmp2, \tmp, \Qprime
    smlal.w \tmp, \out, \tmp2, \Q
    smull.w \tmp, \out, \out, \twiddle
    smlal.w \tmp, \out, \a0, \b0
    mul.w \tmp2, \tmp, \Qprime
    smlal.w \tmp, \out, \tmp2, \Q
.endm
